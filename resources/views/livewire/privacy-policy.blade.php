    ...
    <div class="flex flex-col gap-8 items-center justify-center h-full mx-4 py-6">
        <div class="flex flex-col gap-4 items-center justify-center w-full sm:w-120">
            ...
            <div class="flex flex-col gap-4 py-4">
                ...
                <p>
                    Thank you for visiting Billify. This Privacy Policy outlines how we collect, use, disclose, and
                    safeguard
                    your
                    personal information. By using Billify, you agree to the terms of this Privacy Policy.
                </p>

                <div>
                    <h2 class="text-lg font-bold">1. Information We Collect:</h2>

                    <p>We may collect the following types of information when you use Billify:</p>
                    ...
                    <ul>
                        ...
                        <li><strong>Usage Information:</strong> Information about how you use Billify, including IP
                            address,
                            browser
                            type,
                ...
                <div>
                    ...
                    <p>Billify may use cookies and similar technologies to enhance user experience, analyze trends,
                        and
                        gather
                        information
                ...
                <div>
                    ...
                    <p>Billify may contain links to third-party websites. We are not responsible for the privacy
                        practices
                        or
                        content
                        of
                ...
                <div>
                    ...
                    <p>Billify is not intended for children under the age of 13. We do not knowingly collect personal
                        information
                        from
