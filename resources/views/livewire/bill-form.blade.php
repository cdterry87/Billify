<div x-data="{ isDeleting: false }">
    ...
    <div
        x-show="isDeleting"
        class="flex flex-col items-center justify-center gap-4 w-full text-center px-6"
    >
        <h4 class="font-bold text-3xl">Confirm Deletion</h4>
        <div>
            <h5 class="font-semibold text-xl text-zinc-600">
                Are you sure you want to delete your<br>
                <strong class="text-red-700 underline">{{ $name }}</strong>
                bill?
            </h5>
            <h6 class="text-base text-zinc-500 italic mt-2">This action cannot be undone.</h6>
        </div>
